...
public:
    ...
    //upisivanje povratne vrednosti na stek (na mesto na kom se cuva registar a0)
    static void w_retVal(long a0);
...
inline uint64 Riscv::arg4() {
    uint64 volatile a4;
    __asm__ volatile ("ld %0, 14*8(fp)" : "=r"(a4));
    return a4;
}

inline void Riscv::w_retVal(long a0) {
